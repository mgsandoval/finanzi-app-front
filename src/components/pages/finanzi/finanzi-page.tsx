            ...
            <Card className='w-full max-w-sm shadow-lg bg-white'>
               ...
               <CardContent>
                  <div className='space-y-2'>
                     <Card className='w-full max-w-sm shadow-lg bg-white cursor-pointer' onClick={() => router.push('/finanzi/account#1')}>
                        <CardHeader>
                           <CardTitle>
                              Cuenta 1
                           </CardTitle>
                     ...
                     <Card className='w-full max-w-sm shadow-lg bg-white cursor-pointer' onClick={() => router.push('/finanzi/account#2')}>
                        <CardHeader>
                           <CardTitle>
                              Cuenta 2
                           </CardTitle>
